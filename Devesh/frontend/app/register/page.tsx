...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 1. Generate Advanced Security Keys
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            <label className="mb-1.5 block text-sm font-medium text-zinc-300">
                                Security PIN <span className="text-[10px] text-violet-400 uppercase font-bold">(Key Protection)</span>
                            </label>
                            <div className="relative">
                                <input
                            ...
                            <p className="mt-1.5 text-[10px] text-zinc-500 italic">This PIN will be used to encrypt your identity keys locally.</p>
                        </div>
