...
export default function Navbar() {
    const { user, isAuthenticated, logout, sessionDuration } = useAuth();
                ...
                <nav className="relative flex h-[68px] items-center justify-between rounded-[2rem] border border-white/[0.08] bg-[#0c0c14]/80 px-8 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.4)]">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative" ref={dropdownRef}>
                            ...
                            {isDropdownOpen && (
                                <div className={`absolute right-0 mt-3 w-72 origin-top-right overflow-hidden rounded-3xl border border-white/[0.06] bg-[#0d0d16]/98 shadow-[0_30px_60px_rgba(0,0,0,0.7)] backdrop-blur-3xl transition-all duration-300 ${dropdownMounted ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 -translate-y-2'}`}>
                                    {/* Header */}
                                        ...
                                        <div className="flex items-center gap-3.5">
                                            ...
                                            <div className="overflow-hidden">
                                                ...
                                                <div className="mt-1.5 flex gap-1.5">
                                                    <span className="flex items-center gap-1 rounded-md bg-emerald-500/10 px-1.5 py-0.5 text-[7px] font-bold text-emerald-400 uppercase tracking-widest">
                                                        <span className="h-1 w-1 rounded-full bg-emerald-400" />
                                                        MFA Active
                                                    </span>
                                                    <span className="rounded-md bg-violet-500/10 px-1.5 py-0.5 text-[7px] font-bold text-violet-400 uppercase tracking-widest">
                                                        Free
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div className="px-2.5 pb-1">
                                        <Link href="/profile?tab=personal" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                            ...
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Personal Details</span>
                                        </Link>

                                        <Link href="/profile?tab=storage" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                            ...
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Storage Info</span>
                                        </Link>

                                        <Link href="/connections" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>
                                            </div>
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Connections</span>
                                        </Link>

                                        <Link href="/shared-files" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                            ...
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Shared Files</span>
                                        </Link>

                                        <Link href="/profile?tab=activity" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.094 1.976 1.057 1.976 2.192V16.5A2.25 2.25 0 0118 18.75h-2.25m-7.5-10.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V18.75m-7.5-10.5h6.375c.621 0 1.125.504 1.125 1.125v9.375m-8.25-3l1.5 1.5 3-3.75" /></svg>
                                            </div>
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Activity Log</span>
                                        </Link>

                                        <Link href="/profile?tab=security" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                            ...
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Security</span>
                                        </Link>

                                        <Link href="/help" onClick={() => setIsDropdownOpen(false)} className="group flex items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-white/[0.03] transition-all">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/[0.03] text-zinc-600 group-hover:text-violet-400 transition-colors">
                                                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.858 1.591-2.17a6.75 6.75 0 10-7.682 0c.933.312 1.591 1.187 1.591 2.17V18" /></svg>
                                            </div>
                                            <span className="text-[12px] text-zinc-500 group-hover:text-white transition-colors">Help Center</span>
                                        </Link>
                                    </div>

                                    {/* Logout */}
                                    <div className="px-2.5 pb-2.5 pt-1 border-t border-white/[0.04]">
                                        <button onClick={openLogoutModal} disabled={isLoggingOut} className="flex w-full items-center gap-3 rounded-xl px-2.5 py-1.5 hover:bg-rose-500/[0.06] transition-all group">
                                            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-rose-500/[0.08] text-rose-500">
                                                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M5.636 5.636a9 9 0 1012.728 0M12 3v9" /></svg>
                                            </div>
                                            <span className="text-[12px] text-rose-500">{isLoggingOut ? 'Signing out...' : 'Sign Out'}</span>
                                        </button>
                                    </div>
                                </div>
                            )}
